export const projects = [
  {
    ...
    highlights: [
      "Designed and built front-end and back-end.",
  ...
  {
    name: "Mr. Nyan Cat",
    tools: ["HTML", "CSS", "Javascript", "OOP", "Concordia"],
    description: [
      "A hilarious game where the user is a hamburger and must avoid the army of Nyan Cats rainstorm in space. DISCLAIMER: The music includes great nyan cat jams. However, I strongly suggest to keep the volume on low.",
    ],
    highlights: [],
    link: "https://mr-nyan-kat.netlify.app/",
  },
];
